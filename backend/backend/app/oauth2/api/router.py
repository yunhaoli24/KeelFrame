...
from backend.app.oauth2.api.v1.github import router as github_router
from backend.app.oauth2.api.v1.google import router as google_router
from backend.app.oauth2.api.v1.linux_do import router as linux_do_router
from backend.app.oauth2.api.v1.user_social import router as user_social_router
